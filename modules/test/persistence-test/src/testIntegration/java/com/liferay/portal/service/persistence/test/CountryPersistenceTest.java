...
public class CountryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newCountry.setChannelFilterEnabled(RandomTestUtil.randomBoolean());
		...
		Assert.assertEquals(
			existingCountry.isChannelFilterEnabled(),
			newCountry.isChannelFilterEnabled());
		Assert.assertEquals(
	...
	protected OrderByComparator<Country> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			true, "active", true, "channelFilterEnabled", true,
	...
	protected Country addCountry() throws Exception {
		...
		country.setChannelFilterEnabled(RandomTestUtil.randomBoolean());
