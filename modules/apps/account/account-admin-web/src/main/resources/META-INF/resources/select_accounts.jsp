...
<aui:script use="liferay-search-container">
	var searchContainer = Liferay.SearchContainer.get('<portlet:namespace />accounts');
	...
	searchContainer.on(
		...
		function(event) {
			...
			Liferay.Util.getOpener().Liferay.fire('<%= HtmlUtil.escapeJS(renderResponse.getNamespace() + "selectAccounts") %>', result);
		}
	);
</aui:script>