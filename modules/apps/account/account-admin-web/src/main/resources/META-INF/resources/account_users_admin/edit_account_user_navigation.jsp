...
<%
String actionCommandName = (String)request.getAttribute(AccountWebKeys.ACTION_COMMAND_NAME);
boolean editable = (boolean)request.getAttribute(AccountWebKeys.EDITABLE);
String formLabel = (String)request.getAttribute(AccountWebKeys.FORM_LABEL);
String jspPath = (String)request.getAttribute(AccountWebKeys.JSP_PATH);

User selUser = PortalUtil.getSelectedUser(request);

request.setAttribute(AccountWebKeys.SELECTED_USER, selUser);
...
<aui:form action="<%= actionCommandURL %>" cssClass="portlet-users-admin-edit-user" data-senna-off="true" method="post" name="fm">
	...
	<div class="sheet sheet-lg">
		<c:if test="<%= (boolean)request.getAttribute(AccountWebKeys.SHOW_TITLE) %>">
		...
		<c:if test="<%= editable && (boolean)request.getAttribute(AccountWebKeys.SHOW_CONTROLS) %>">
