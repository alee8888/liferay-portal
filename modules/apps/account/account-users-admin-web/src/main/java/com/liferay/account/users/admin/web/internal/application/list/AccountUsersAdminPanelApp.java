...
package com.liferay.account.users.admin.web.internal.application.list;
...
public class AccountUsersAdminPanelApp extends BasePanelApp {
	...
	public String getPortletId() {
		return AccountsPortletKeys.ACCOUNT_USERS_ADMIN;
	}

	@Override
	@Reference(
		target = "(javax.portlet.name=" + AccountsPortletKeys.ACCOUNT_USERS_ADMIN + ")",
		unbind = "-"
	)
