...
public class CountryUtil {
	 ...
	 * @throws NoSuchCountryException if a matching country could not be found
	 */
	public static Country findByC_N(long companyId, String number)
		throws com.liferay.portal.kernel.exception.NoSuchCountryException {

		return getPersistence().findByC_N(companyId, number);
	}
	 ...
	 * @return the matching country, or <code>null</code> if a matching country could not be found
	 */
	public static Country fetchByC_N(long companyId, String number) {
		return getPersistence().fetchByC_N(companyId, number);
	}
	...
	public static Country fetchByC_N(
		...
		return getPersistence().fetchByC_N(companyId, number, useFinderCache);
	}
	 ...
	 * @return the country that was removed
	 */
	public static Country removeByC_N(long companyId, String number)
		throws com.liferay.portal.kernel.exception.NoSuchCountryException {

		return getPersistence().removeByC_N(companyId, number);
	}
	 ...
	 * @return the number of matching countries
	 */
	public static int countByC_N(long companyId, String number) {
		return getPersistence().countByC_N(companyId, number);
	}
