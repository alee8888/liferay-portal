...
public class DefinePermissionsRoleAddDocumentSiteOnTest extends BaseTestCase {
	public void testDefinePermissionsRoleAddDocumentSiteOn()
		...
		selenium.waitForText("//div[4]/div/div/table/tbody/tr[4]/td[3]",
			"Portal");
		assertEquals(RuntimeVariables.replace("Portal"),
			selenium.getText("//div[4]/div/div/table/tbody/tr[4]/td[3]"));
		...
		selenium.selectWindow("null");
		Thread.sleep(5000);
		selenium.waitForText("//div[4]/div/div/table/tbody/tr[4]/td[3]/div/span/span/span",
			"Liferay");
		assertEquals(RuntimeVariables.replace("Liferay"),
			selenium.getText(
				"//div[4]/div/div/table/tbody/tr[4]/td[3]/div/span/span/span"));
