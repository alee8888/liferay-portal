...
public class CountryPersistenceImpl
	 ...
	 */
	@Override
	public Country findByC_N(long companyId, String number)
		throws NoSuchCountryException {

		Country country = fetchByC_N(companyId, number);
	 ...
	 */
	@Override
	public Country fetchByC_N(long companyId, String number) {
		return fetchByC_N(companyId, number, true);
	}
	 ...
	 */
	@Override
	public Country removeByC_N(long companyId, String number)
		throws NoSuchCountryException {

		Country country = findByC_N(companyId, number);
	 ...
	 */
	@Override
	public int countByC_N(long companyId, String number) {
		number = Objects.toString(number, "");
